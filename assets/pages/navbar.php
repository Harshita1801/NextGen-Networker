<?php global $user;?>
    <nav class="navbar navbar-expand-lg navbar-light bg-violet border">
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand " href="?">
                    <img src="assets/images/title.jpg" alt="" height="80" >
...
<p class="text-center text-muted">enter name or username</p>
            ...
            <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="?"><i class="bi bi-house-door" style="font-size: 30px;"></i></a>
                </li>
                <li class="nav-item">
                    
                    <a class="nav-link text-dark" data-bs-toggle="modal" data-bs-target="#addpost" href="#"><i class="bi bi-plus-square" style="font-size: 30px;"></i></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" data-bs-toggle="offcanvas" href="#message_sidebar" href="#"><i class="bi bi-chat-dots" style="font-size: 30px;"></i> 
                ...
                <li class="nav-item dropdown dropstart">
                    <a class="nav-link" href="#" id="navbarDropdown" role="button"
                        ...
                        <img src="assets/images/profile/<?=$user['profile_pic']?>" alt="" height="40" width="40" class="rounded-circle border shadow">
                    </a>
