...
foreach($posts as $post){
    ...
    ?>
     <div class="card mt-4 ">
                <div class="card-title d-flex justify-content-between bg-violet align-items-center">
  ...
  <div class="modal-content">
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div class="d-flex align-items-center p-2">
                <div><img src="assets/images/profile/<?=$user['profile_pic']?>" alt="" height="60" width="60" class="rounded-circle border shadow">
                </div>
                <div>&nbsp;&nbsp;&nbsp;</div>
                <div class="d-flex flex-column justify-content-center">
...
<div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center p-2">
                        <div><img src="assets/images/profile/<?=$suser['profile_pic']?>" alt="" height="40" width="40" class="shadow rounded-circle border">
                        </div>
                        <div>&nbsp;&nbsp;</div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-primary followbtn shadow" data-user-id='<?=$suser['id']?>' >Follow</button>
